...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        carService.add(new Car("BMW", 153));
        carService.add(new Car("KIA", 542));
        carService.add(new Car("Cherru", 242));
        carService.add(new Car("RR", 777));
        ...
        System.out.println(userService.select("KIA", 542));
        context.close();
